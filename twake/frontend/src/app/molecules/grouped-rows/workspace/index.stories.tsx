      ...
      <div className="w-96 border border-gray-300 rounded-sm px-2 m-2">
        <WorkspaceBlock
          avatar={
            <Avatar
              type="square"
              avatar="https://s3.eu-west-3.amazonaws.com/Noted For Action.eu-west-3/public/uploads/grouplogo/dffc6bb54e7b5d6ee45d2d877839aa88.png"
            />
          }
          title="Home"
        ...
        <WorkspaceBlock
          avatar={
            <Avatar
              type="square"
              avatar="https://s3.eu-west-3.amazonaws.com/Noted For Action.eu-west-3/public/uploads/wslogo/2bb1d89d73e9597140d48fc095737f23.png"
            />
          }
          title="Software"
